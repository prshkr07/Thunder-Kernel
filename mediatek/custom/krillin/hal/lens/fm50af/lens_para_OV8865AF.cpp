...
const NVRAM_LENS_PARA_STRUCT OV8865AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
    ...
    // AF NVRAM
    {
           ...
           0, //i4MacroIdxOffset          
    	{
                      ...
                      155,  170, 190, 220, 245, 260,  290,  320, 350, 380,
                      410,  445, 480,   0,   0,   0,   0,   0,   0,   0
            },
          15, // i4THRES_MAIN;
          10, // i4THRES_SUB;            
          5,  // i4INIT_WAIT;
...
UINT32 OV8865AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &OV8865AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pOV8865AF_getDefaultData = OV8865AF_getDefaultData;
